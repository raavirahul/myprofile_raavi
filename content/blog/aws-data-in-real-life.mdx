...
<Figure
  src="/blog/aws-data-in-real-life/hero.jpeg"
  alt="Lakehouse overview"
  width={1600}
  height={900}
  caption="Raw → Bronze → Silver → Gold"
/>
...
1. **Ingestion** – Stream or batch data into S3 using Kinesis or Firehose.  
2. **Transformation** – Process with Glue jobs written in PySpark.  
3. **Querying** – Query curated data via Athena with SQL.  
4. **Analytics** – Build dashboards in QuickSight for stakeholders.
